...
class Configurable(object):
    ...
    @property
    def is_meta(self):
        return self._conf.getint('Run', 'is_meta') > 0
    ...
    @property
    def is_meta_weight(self):
        return self._conf.getint('Run', 'is_meta_weight') > 0
    ...
    def meta_learning_rate(self):
        return self._conf.getfloat('Optimizer', 'meta_learning_rate')
    
    @property
    def meta_loss(self):
        return self._conf.getfloat('Optimizer', 'meta_loss')
